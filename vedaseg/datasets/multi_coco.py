...
class MultiCocoDataset(BaseDataset):
    ...
    def _set_group_flag(self):
        ...
        for i in range(len(self)):
            ...
            names = data_info['filename']
            if 'normal' in names or names[-1][0] == 'N':
                self.norm_flag[i] = 1
            else:
                self.norm_flag[i] = 0
    ...
    def __getitem__(self, idx):
        ...
        if len(self.transform.bitransforms) > 0:
            ...
            ori_img2, img2, dmasks2, label2, _ = self._get_img_info(idx2)
        else:
        ...
        if self.infer:
            ...
            return img, (mask, torch.from_numpy(label))
