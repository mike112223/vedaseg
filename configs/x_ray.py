...
dataset_root = 'data/tianchi/jinnan2_round2_train_20190401/jinnan2_round2_train_20190401'
data = dict(
    train=dict(
        dataset=dict(
            type=dataset_type,
            ann_file='knife_restriction.json',
    ...
    val=dict(
        ...
        transforms=[
            dict(type='PadIfNeeded', height=993, width=1153, image_value=img_norm_cfg['mean'], mask_value=ignore_label),
            dict(type='Normalize', **img_norm_cfg),
            dict(type='ToTensor'),
        ],
        loader=dict(
